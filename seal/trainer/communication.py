...
class CommunicationModel:
    ...
    def to_csv(self, path) -> None:
        ...
        for tls in self.tls_ids:
            ...
            aux_data["edge_to_tls_action_comms"] = self.__edge_to_tls_action_comms[tls]
            aux_data["edge_to_tls_rank_comms"] = self.__edge_to_tls_rank_comms[tls]
            aux_data["edge_to_tls_policy_comms"] = self.__edge_to_tls_policy_comms[tls]
            aux_data["tls_to_edge_obs_comms"] = self.__tls_to_edge_obs_comms[tls]
            aux_data["tls_to_edge_policy_comms"] = self.__tls_to_edge_policy_comms[tls]
            aux_data["veh_to_tls_info_comms"] = self.__veh_to_tls_info_comms[tls]
