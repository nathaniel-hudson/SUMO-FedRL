...
STATES = [STATE_r, STATE_y, STATE_g, STATE_G, STATE_s, STATE_u, STATE_o, STATE_O]
...
STATE_INT_TO_STR = {int_id: str_id for (int_id, str_id) in zip(STATES, STATE_STRS)}
STATE_STR_TO_INT = {str_id: int_id for (int_id, str_id) in zip(STATES, STATE_STRS)}